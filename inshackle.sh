...
ruben_onsu="26444210"
ridwankamil="40528624"
cgulla="48667339"
keanugl="11884728317"
raffinagita1717="1918078581"
jessnolimit="4706082810"
...
if [[ ! -e celeb_id ]]; then
printf "%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n" $riaricis1795 $prillylatuconsina96 $ayutingting92 $ruben_onsu $ridwankamil $cgulla $keanugl $raffinagita1717 $jessnolimit $attahalilintar $pst0re $awkarin $jokowi > celeb_id
fi
